...
def get_scatter_chart(entered_site, payload):
    ...
    filter_df = (spacex_df['Payload Mass (kg)'] > payload[0]) & (spacex_df['Payload Mass (kg)'] < payload[1])
    intermediate_df = spacex_df[filter_df]

    if entered_site == 'ALL':
        filtered_df = intermediate_df
    else:
        filtered_df = intermediate_df[intermediate_df['Launch Site'] == entered_site]
